...
[System.Serializable] // 구조체를 인스펙터에 표시하려면 Serializable 어트리뷰트를 추가해야 합니다.
public struct PlayerInfo
{
	public string playerName;
	public StateExample state;   // 이전 enum 강의에서 만든 상태 Enum
	public Buffs buffs;          // EnumFlag에서 만든 Buffs
