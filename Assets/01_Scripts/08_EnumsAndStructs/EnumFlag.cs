...
public enum Buffs
{
	...
	// 쉬프트 연산자를 사용하여 각 값이 2의 거듭제곱이 되도록 설정합니다.
	// << : 비트 단위로 왼쪽으로 이동시키는 연산자입니다.
	// 0b : 이진수 표기법이라는 뜻입니다.

	Strength = 1 << 0,       // 0b0001 (1)
    Agility = 1 << 1,        // 0b0010 (2)
    Intelligence = 1 << 2,   // 0b0100 (4)
    Stamina = 1 << 3,        // 0b1000 (8)
    All = Strength | Agility | Intelligence | Stamina // 0b1111 (15)
}
